...
credhub set -t value -n '/lab-foundation/harbor-container-registry/admin_password' -v 'REDACTED_PASSWORD'
credhub set -t certificate -n '/lab-foundation/harbor-container-registry/server_cert_key' -c harbor.certificate -p harbor.private-key -r harbor.ca
